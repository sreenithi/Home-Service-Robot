...
int main(int argc, char** argv){
  ...
  pickup_zone.target_pose.pose.position.x = -7.0;
  pickup_zone.target_pose.pose.position.y = -1.2;
  ...
  dropoff_zone.target_pose.pose.position.x = -2.2;
  dropoff_zone.target_pose.pose.position.y = 6.0;
